# ⭐ 堅占星 Kin Astro — 二十五體系占星排盤平台

> 融合全球二十五種中外古今占星體系的線上排盤平台，支援 AI 智慧分析、中英雙語介面，免費開源。

🔮 **線上使用 Live App**：<https://kinastro.streamlit.app>  
📦 **原始碼 Source Code**：<https://github.com/kentang2017/kinastro>  
🌐 **所有專案 All Projects**：<https://kentang2017.github.io>
...
| 功能 | 說明 |
|------|------|
| 🔮 二十五體系合一 | 中國、西方、亞洲、中東、古代文明——在同一介面切換，無需來回換工具 |
...
| 體系 | 英文名 | 關鍵特色 |
|------|--------|----------|
| 西洋占星 | Western Astrology | 本命盤輪圖、行星過運、太陽回歸、合盤比較、恆星合相、小行星 |
| 希臘占星 | Hellenistic Astrology | Greek Lots、Egyptian Bounds、Annual Profections、Zodiacal Releasing |
...
| 體系 | 英文名 | 關鍵特色 |
|------|--------|----------|
| 印度占星 Jyotish | Vedic Astrology | 南/北印度盤、Vimshottari 大運、Ashtakavarga、16 Varga 分盤 |
| 納迪占星 | Nadi Astrology | 三大脈輪、27 星宿、納迪宮分 |
| Jaimini 占星 | Jaimini Astrology | Chara Karaka、Rashi Drishti、Chara Dasha |
...
| 體系 | 英文名 | 關鍵特色 |
|------|--------|----------|
| 阿拉伯占星 | Arabic Astrology | 阿拉伯點、Picatrix 星體魔法、太陽知識大全 |
...
- **`index.html`** — [堅占星 Kin Astro 官方介紹頁](https://kentang2017.github.io/)
- **`kentang2017.html`** — [所有開源專案總覽](https://kentang2017.github.io/kentang2017.html)
...
- **微信 WeChat**：`gnatnek`
- **公眾號**：探究三式
- **贊助 Sponsor**：<https://github.com/sponsors/kentang2017>
