...
> 融合全球 **三十二種** 中外古今占星體系的線上排盤平台，支援 **Cerebras AI** 智慧分析、中英雙語介面，免費開源。
>
> The online astrology charting platform that unites **32 systems** — Chinese, Western, Asian, Middle-Eastern & Ancient — with Cerebras AI analysis, bilingual UI, and open-source code.
...
| 功能 | 說明 |
|------|------|
| 🔮 **三十二體系合一** | 三式、中國、西方、亞洲、中東、古代文明——在同一介面切換，無需來回換工具 |
| 🪐 **精密天文計算** | 採用瑞士星曆表 Swiss Ephemeris (pyswisseph) 進行高精度行星運算 |
| 🤖 **Cerebras AI 智慧分析** | 整合 Cerebras Cloud LLM，一鍵生成命盤深度解讀報告 |
...
| **天王星漢堡學派** | Uranian / Hamburg School | Alfred Witte 漢堡學派、90° 度盤、行星圖像（A+B−C=D）、中點樹、八顆超海王星虛點 |
...
| **九星氣學** | Nine Star Ki | 日本九星氣學、本命星/月命星/日命星、洛書九宮、五行相性分析 |
...
| **薩珊波斯占星** | Sassanian Persian Astrology | 古代波斯傳統、恆星黃道、菱形十二宮、Firdar 生命週期、Hyleg/Alcocoden、王者固定星 |
